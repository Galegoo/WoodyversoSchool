    ...
    public class ConnectionManager : MonoBehaviour, INetworkRunnerCallbacks
    {
        ...
        public void OnPlayerJoined(NetworkRunner runner, PlayerRef player)
        {
            ...
            if (runner.IsServer)
            {
                ...
                foreach(NetworkBehaviour behaviour in networkPlayerObject.NetworkedBehaviours)
                {
                ...
                //amountOfPlayersOnline.text = "Usuários online: " + _spawnedUsers.Count;
            }
        }
        ...
        public Dictionary<PlayerRef, NetworkObject> GetSpawnedUsers()
        {
            return _spawnedUsers;
        }
    }
